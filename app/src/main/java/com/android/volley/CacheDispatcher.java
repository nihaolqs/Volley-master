 ...
 */
public class CacheDispatcher extends Thread {  //缓存分派线程

    private static final boolean DEBUG = VolleyLog.DEBUG;

    /** The queue of requests coming in for triage. */
    private final BlockingQueue<Request<?>> mCacheQueue;    //分类请求队列
    ...
    private final ResponseDelivery mDelivery;  //响应结果监听
